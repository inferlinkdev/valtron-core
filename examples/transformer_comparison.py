...
DATA = [
    {
        "id": "1",
        "content": "The court ruled against the defendant in the criminal case.",
        "label": "legal",
    },
    {
        "id": "2",
    ...
    {
        "id": "3",
        "content": "The central bank raised interest rates by 25 basis points.",
        "label": "finance",
    },
    {
        "id": "4",
        "content": "The senator introduced a bill to reform healthcare legislation.",
        "label": "legal",
    },
    {
        "id": "5",
        "content": "Researchers published findings on quantum computing error correction.",
        "label": "science",
    },
    {
        "id": "6",
        "content": "The stock market fell sharply on disappointing earnings reports.",
        "label": "finance",
    },
    {"id": "7", "content": "The jury delivered a unanimous guilty verdict.", "label": "legal"},
    {
        "id": "8",
        "content": "A new vaccine shows 95% efficacy in clinical trials.",
        "label": "science",
    },
    {
        "id": "9",
        "content": "Inflation rose to its highest level in four decades.",
        "label": "finance",
    },
    {
        "id": "10",
        "content": "The appeals court overturned the lower court's decision.",
        "label": "legal",
    },
    {
        "id": "11",
        "content": "Astronomers detected gravitational waves from a binary star merger.",
        "label": "science",
    },
    {
        "id": "12",
        "content": "The Federal Reserve signaled a pause in rate hikes.",
        "label": "finance",
    },
    {
        "id": "13",
        "content": "A landmark ruling expanded civil liberties protections.",
        "label": "legal",
    },
    {
        "id": "14",
        "content": "Gene-editing therapy reverses rare genetic disorder in trial.",
        "label": "science",
    },
    {
        "id": "15",
        "content": "Venture capital funding hit a five-year low last quarter.",
        "label": "finance",
    },
    {
        "id": "16",
        "content": "The Supreme Court agreed to hear the antitrust case.",
        "label": "legal",
    },
]
