...
### Install and start your model server
...
### Configure Valtron to point at your server
...
### Track infrastructure costs (optional)
...
```{rubric} Cost comparison example (10,000 calls)
```
