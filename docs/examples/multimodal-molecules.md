...
- [`ClassificationExperiment`](../api/classification_experiment) with numeric string labels
...
- Use `response_format` with a Pydantic schema to extract structured answers (e.g. molecular formula + carbon count together). See [Evaluation Results](../user-guide/classification/evaluation-results).
