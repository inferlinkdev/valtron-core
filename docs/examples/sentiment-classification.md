...
- Minimal [`ClassificationExperiment`](../api/classification_experiment) setup
...
See [Data Format](../user-guide/classification/data-format) for more details.
...
- Add a third model or a per-model prompt override. See [Recipes](../user-guide/classification/evaluation-api).
- Load these results later and extend them. See [Incremental Evaluation](./incremental-evaluation).
- Add few-shot examples to improve accuracy. See [Prompt Manipulations](../user-guide/manipulations/index).
