...
The configuration wizard is a browser-based UI that walks you through building a Valtron config file step by step. It is the fastest way to get a working config without writing JSON by hand. For fine-grained control over every available option, see the [Config Format](../user-guide/classification/config-format) reference.
...
![Step 1: Current Model](/_static/img/1_wizard_current_model.png)
...
![Step 2: Select Models](/_static/img/2_wizard_select_models.png)
...
![Step 3: Training Data](/_static/img/3_wizard_training_data.png)
...
Your data must be a JSON array. See [Data Format](../user-guide/classification/data-format) for the full spec. A minimal example:
...
![Step 4: Response Format](/_static/img/4_wizard_response_format.png)

The wizard displays the Pydantic model inferred from your label values. This is a best-effort inference from your data: if you need a more precise schema, pass your own Pydantic model directly as `response_format` when constructing `ModelEval`. See [Extraction Config Format](../user-guide/extraction/config-format.md) for details.
...
![Step 5: Field-Level Metrics](/_static/img/5_wizard_field_metrics.png)
...
See [Field Metrics](../user-guide/extraction/field-metrics/index) for a full reference.

---

## Step 6: Prompt

![Step 6: Prompt](/_static/img/6_wizard_prompt.png)
...
![Step 7: Review and Download](/_static/img/7_wizard_review.png)
...
See [Config Format](../user-guide/classification/config-format) for a full reference of every config field, and [Chapter 1: Classification](../user-guide/classification/index) for a minimal end-to-end example.
